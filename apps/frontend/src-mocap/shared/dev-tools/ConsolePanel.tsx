...
import {
    ...
    useLogStats,
    logLevelColor,
} from '@mocap/shared/state/consoleStore';
import { LogLevel } from '@mocap/shared/state/LogLevel';
...
const LEVEL_OPTIONS: LogLevel[] = [LogLevel.ERROR, LogLevel.WARN, LogLevel.INFO, LogLevel.DEBUG];
...
function LevelIcon({ level }: { level: LogLevel }) {
    ...
    switch (level) {
        case LogLevel.ERROR: return <AlertCircle size={size} color={color} />;
        case LogLevel.WARN: return <AlertTriangle size={size} color={color} />;
        case LogLevel.INFO: return <Info size={size} color={color} />;
        case LogLevel.DEBUG: return <Bug size={size} color={color} />;
