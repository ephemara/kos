...
export class WebGPUFluidEngine {
    ...
    async initialize(): Promise<void> {
        ...
        const [
            ...
            fetch('/src/features/quantum/fluid/shaders/advection.wgsl').then(r => r.text()),
            fetch('/src/features/quantum/fluid/shaders/pressure.wgsl').then(r => r.text()),
            fetch('/src/features/quantum/fluid/shaders/forces.wgsl').then(r => r.text()),
        ]);
