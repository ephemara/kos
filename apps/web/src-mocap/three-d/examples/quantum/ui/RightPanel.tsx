...
export function ExportTab({
    ...
    recResolution, setRecResolution, status
}: ExportTabProps) {
    return (
        <div className="flex flex-col gap-6 p-4">
            {/* VIDEO EXPORT */}
            ...
            {appMode === 'CHRONOS' && (
                <div className="space-y-3 animate-in fade-in slide-in-from-right-2">
                    <div className="flex items-center gap-2 text-[10px] font-bold text-purple-500">
                        <Film size={12} /> CHRONOS PIPELINE
                    </div>

                    <div className="bg-purple-900/10 border border-purple-500/20 p-3 rounded space-y-2">
                        <div className="text-[10px] text-purple-300">
                            Sequencer & VAT Export unavailable in Preview.
                        </div>
                    </div>
                </div>
            )}
