...
This guide exists for recurring automation runs working on `src-game`.
...
- do not rebuild a second monolith under `src-game`
...
- update `src-game/docs/RUN_LOG_2026-03-11.md`
- update `src-game/docs/PIPELINE_ARCHITECTURE.md` if runtime/pipeline guarantees change
- update `src-game/docs/CRATE_ARCHITECTURE.md` if ownership changes
