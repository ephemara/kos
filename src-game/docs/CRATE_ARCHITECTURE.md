...
It exists to stop the game-engine effort from turning into a second monolith spread across `k-os-bevy`, `src-game`, and whichever legacy crate happens to be convenient.
...
- `src-game` holds product data, docs, assets, and pipeline manifests
