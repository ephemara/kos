...
def test_lance_db():
    ...
    test_embeddings = [
        ...
        CodeEmbedding(
            file_path="sources/python/DocGen/core/embedding_engine.py",
            content_hash="ghi789",
    ...
    # Test deletion
    logger.info("\n8. Testing deletion")
    db_manager.delete_by_path("sources/python/DocGen/core/embedding_engine.py")
    
    # Verify deletion
    deleted = db_manager.get_by_path("sources/python/DocGen/core/embedding_engine.py")
    if deleted is None:
