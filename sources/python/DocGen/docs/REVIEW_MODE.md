...
python sources/python/DocGen/scripts/generate.py --review-mode

# Review READMEs for a specific directory
python sources/python/DocGen/scripts/generate.py --path crates/k-os-engine --review-mode

# Combine with other flags
python sources/python/DocGen/scripts/generate.py --review-mode --force --provider gemini
```
...
Located in: `sources/python/DocGen/scripts/generate.py`
