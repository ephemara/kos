...
Usage:
    python sources/python/DocGen/scripts/index_stats.py
    python sources/python/DocGen/scripts/index_stats.py --json
    python sources/python/DocGen/scripts/index_stats.py --path crates/k-os-engine
