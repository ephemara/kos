...
Usage:
    python src-python/DocGen/scripts/update_index.py
    python src-python/DocGen/scripts/update_index.py --full-reindex
    python src-python/DocGen/scripts/update_index.py --path crates/k-os-engine
