#!/usr/bin/env python3
"""
Standalone unit tests for CostTracker module

Tests cost tracking, budget enforcement, cost estimation, and logging functionality.
This version imports only the cost_tracker module to avoid dependency issues.
"""
...
# Import directly from cost_tracker module to avoid embedding engine dependencies
import importlib.util
spec = importlib.util.spec_from_file_location("cost_tracker", Path(__file__).parent / "core" / "cost_tracker.py")
...
CostEntry = cost_tracker_module.CostEntry
