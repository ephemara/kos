...
**Location:** `src-python/DocGen/scripts/generate.py` (lines 57-180)
...
**Location:** `src-python/DocGen/scripts/generate.py` (lines 183-233)
...
**Location:** `src-python/DocGen/scripts/generate.py` (line 660)
