...
import sys
import os
os.chdir(r'M:\K_OS\src-python\UI')
sys.path.insert(0, r'M:\K_OS\src-python\UI')
...
"""
    ...
    for result in results:
        if result.success:
            ...
            if png_path:
                rel_path = os.path.relpath(png_path, r'M:\K_OS\src-python\UI')
...
"""
    ...
    gallery_path = r'M:\K_OS\src-python\UI\showcase_gallery.html'
