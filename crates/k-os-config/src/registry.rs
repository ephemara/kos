    ...
    fn load_embedded_defaults(&mut self) {
        ...
        self.register_brush(BrushConfig {
            ...
            parameters: {
                ...
                params.insert("hardness".into(), BrushParameter::Float { default: 0.5, min: 0.0, max: 1.0 });
                params.insert("flow".into(), BrushParameter::Float { default: 1.0, min: 0.0, max: 1.0 });
                params.insert("opacity".into(), BrushParameter::Float { default: 1.0, min: 0.0, max: 1.0 });
                params
            },
        });
        ...
        self.register_brush(BrushConfig {
            ...
            parameters: {
                let mut params = HashMap::new();
                params.insert("hardness".into(), BrushParameter::Float { default: 1.0, min: 0.0, max: 1.0 });
                params.insert("flow".into(), BrushParameter::Float { default: 1.0, min: 0.0, max: 1.0 });
                params.insert("opacity".into(), BrushParameter::Float { default: 1.0, min: 0.0, max: 1.0 });
                params
            },
        ...
        self.register_brush(BrushConfig {
            ...
            parameters: {
                let mut params = HashMap::new();
                params.insert("hardness".into(), BrushParameter::Float { default: 0.0, min: 0.0, max: 1.0 });
                params.insert("flow".into(), BrushParameter::Float { default: 0.5, min: 0.0, max: 1.0 });
                params.insert("opacity".into(), BrushParameter::Float { default: 0.8, min: 0.0, max: 1.0 });
                params
            },
        });
        ...
        self.register_brush(BrushConfig {
            ...
            parameters: {
                let mut params = HashMap::new();
                params.insert("hardness".into(), BrushParameter::Float { default: 0.2, min: 0.0, max: 1.0 });
                params.insert("flow".into(), BrushParameter::Float { default: 0.3, min: 0.0, max: 1.0 });
                params.insert("opacity".into(), BrushParameter::Float { default: 0.5, min: 0.0, max: 1.0 });
                params
            },
        });
        ...
        self.register_brush(BrushConfig {
            ...
            parameters: {
                let mut params = HashMap::new();
                params.insert("hardness".into(), BrushParameter::Float { default: 0.5, min: 0.0, max: 1.0 });
                params.insert("flow".into(), BrushParameter::Float { default: 0.8, min: 0.0, max: 1.0 });
                params
            },
        });
        ...
        log::info!("[ConfigRegistry] Loaded {} default brushes", self.brushes.len());
        log::info!("[ConfigRegistry] Loaded {} default export formats", self.export_formats.len());
        log::info!("[ConfigRegistry] Loaded {} default viewport presets", self.viewport_presets.len());
        ...
        log::info!("[ConfigRegistry] Loaded {} default shading modes", self.shading_modes.len());
    }
...
pub fn list_config_brushes() -> Vec<BrushConfig> {
    GLOBAL_CONFIG.read().list_brushes().into_iter().cloned().collect()
}

#[cfg_attr(all(not(target_arch = "wasm32"), feature = "tauri-commands"), tauri::command)]
pub fn list_config_export_formats() -> Vec<ExportFormatConfig> {
    GLOBAL_CONFIG.read().list_export_formats().into_iter().cloned().collect()
}

#[cfg_attr(all(not(target_arch = "wasm32"), feature = "tauri-commands"), tauri::command)]
pub fn list_config_viewport_presets() -> Vec<ViewportPresetConfig> {
    GLOBAL_CONFIG.read().list_viewport_presets().into_iter().cloned().collect()
}
...
pub fn list_config_shading_modes() -> Vec<ShadingModeConfig> {
    GLOBAL_CONFIG.read().list_shading_modes().into_iter().cloned().collect()
}

#[cfg_attr(all(not(target_arch = "wasm32"), feature = "tauri-commands"), tauri::command)]
pub fn list_config_shading_modes_by_app(app: String) -> Vec<ShadingModeConfig> {
    GLOBAL_CONFIG.read().list_shading_modes_by_app(&app).into_iter().cloned().collect()
}
