...
pub const RENDERER_SCREEN_COMPOSIT_TEST_BYTES: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/generated/spv/renderer/renderer_screen_composit_test.spv"));
pub static RENDERER_SCREEN_COMPOSIT_TEST: crate::GeneratedSpirvAsset = crate::GeneratedSpirvAsset {
    id: "renderer_screen_composit_test",
    label: "Renderer Screen Composit Test",
    domain: crate::KainDomain::Renderer,
    source_path: "crates/k-os-kain/domains/renderer/renderer_screen_composit_test.kn",
    compiled_path: "crates/k-os-kain/generated/spv/renderer/renderer_screen_composit_test.spv",
    bytes: RENDERER_SCREEN_COMPOSIT_TEST_BYTES,
};
pub fn renderer_screen_composit_test() -> &'static crate::GeneratedSpirvAsset { &RENDERER_SCREEN_COMPOSIT_TEST }
...
pub static ALL: &[GeneratedSpirvLookupEntry] = &[
    ...
    GeneratedSpirvLookupEntry { id: "renderer_screen_composit_test", asset: &RENDERER_SCREEN_COMPOSIT_TEST },
...
pub fn by_id(id: &str) -> Option<&'static crate::GeneratedSpirvAsset> {
    match id {
        ...
        "renderer_screen_composit_test" => Some(&RENDERER_SCREEN_COMPOSIT_TEST),
