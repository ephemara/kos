...
import { kos } from './api';
import type { SculptState, BrushLibrary, AppState, LayerHierarchy } from './api';
...
interface KosStoreState {
    ...
    // Internal sync
    _syncFromBevy: (state: AppState) => void;
...
export const useKosStore = create<KosStoreState>()(
    subscribeWithSelector((set, get) => ({
        ...
        _syncFromBevy: (appState) => {
            const sculpt = appState.sculpt;
