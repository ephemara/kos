...
import { ThumbnailGen } from '@mocap/shared/services/thumbnailGenerator'
import { loadModel } from '@mocap/three-d/systems/three/threeImport';
import { exportScene } from '@mocap/three-d/systems/three/threeExport';
...
export const saveProject = async (
    ...
    try {
        ...
        link.href = url;
        link.download = `KIPP_PROJECT_${new Date().toISOString().split('T')[0]}.kipp`;
