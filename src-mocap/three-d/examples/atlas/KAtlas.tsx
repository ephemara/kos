...
import { Layers, Settings, LayoutGrid, Zap, Box, Cpu } from 'lucide-react';
import { normalizeObject, ensureUVs, MeshImportProfiles } from '@mocap/three-d/systems/three/meshPipeline';
...
import type { ProjectionMode } from '@mocap/three-d/services/atlasClient';
        ...
        <AppShell
            ...
            topBar={
                <TopBar
                    ...
                    uvViewMode={uvViewMode}
                    setUvViewMode={setUvViewMode}
                    viewMode={viewMode}
