 ...
 * Select Primitive
 * 
 * A styled select component built on Radix UI.
 */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-9 w-full items-center justify-between rounded-md border border-zinc-800',
      'bg-zinc-900 px-3 py-2 text-sm text-gray-300',
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-50 min-w-[8rem] overflow-hidden rounded-md border border-zinc-800',
        'bg-zinc-900 text-gray-300 shadow-md',
