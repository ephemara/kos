...
import { getKMaterialBakedMaps, getKMaterialPreviewUrl } from '@/systems/materials/KMaterialAsset';
import { resolveToThreeStandardMaterial } from '@/systems/materials/materialResolver';
