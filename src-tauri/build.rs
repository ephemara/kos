...
fn export_specta_tauri_bindings(root: &Path) {
    ...
    let generated_dir = root.join("src-frontend").join("generated");
    let generated_file = generated_dir.join("tauriRegistry.gen.ts");

    fs::create_dir_all(&generated_dir).expect("Failed to create src-frontend/generated");

    let mut output = String::new();
    output.push_str("// AUTO-GENERATED BY src-tauri/build.rs. DO NOT EDIT.\n");
